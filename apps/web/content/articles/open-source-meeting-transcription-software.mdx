...
| **Platforms**          | macOS, Windows, Linux                   | Windows, macOS, Linux | macOS (Windows in progress) |
| **License**            | MIT                                 | MIT                       | MIT                          |
| **Meeting Support**    | All platforms, no bots              | All platforms, no bots    | Dictation; meeting capture planned |
| **Local Models**       | Whisper, Ollama, LM Studio          | Whisper.cpp, Ollama       | Whisper, Ollama              |
...
| **Organization Plans** | Pro ($15/mo or $150/yr), Enterprise (custom) | Custom (2-100 users) | None currently               |
...
The interface pairs a lightweight note editor with recent meetings and optional calendar context. You can start from a blank note, capture the call, and keep the resulting transcript and summary in the same local workspace.
...
**Available as:** Native macOS app, with Windows and Linux builds in beta.

![Anarlog](/images/blog/library/products/anarlog/desktop/2026-08-27-new-note.png)
...
![Meetily](/images/blog/articles/open-source-meeting-transcription-software/meetily.webp)
...
![Amical floating recorder dictating a structured follow-up email in Gmail](/images/blog/library/products/amical/dictation/2026-08-30-demo.gif)

*Amical's official README demo shows its floating recorder turning speech into a structured Gmail draft. Source: [Amical on GitHub](https://github.com/amicalhq/amical#-overview).*
...
Ready to try it? [Download Anarlog](/download) or [check out the source code on GitHub](https://github.com/fastrepl/anarlog).
