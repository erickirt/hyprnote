...
<Image src="/images/blog/articles/google-gemini-data-retention-policy/gemini-retention-by-tier.png" alt="Gemini data retention differences across the consumer app, API, and Workspace Enterprise" />
...
## Use Gemini's API for Meeting Notes Through Anarlog
...
Anarlog is an open-source AI notepad for meetings that lets you bring your own API key for Gemini, OpenAI, Anthropic, Mistral, or others. Your meeting notes are stored on your device. You choose which AI provider processes your data, and you can change that decision without rebuilding your workflow.

For teams that need to go further, Anarlog supports fully local models via Ollama. Your conversations never leave your device at all.
