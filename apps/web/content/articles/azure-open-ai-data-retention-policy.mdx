...
![Where prompts go in Azure OpenAI: the default abuse-monitoring path and the approved zero-retention path](/images/blog/articles/azure-open-ai-data-retention-policy/azure-openai-data-flow.png)
...
## Using Azure OpenAI Through Anarlog

[Anarlog](https://anarlog.so) supports custom API endpoints, which means you can connect your Azure OpenAI deployment directly. Your meeting data goes through your Azure subscription under your enterprise data policy.

If your organization has a Modified Abuse Monitoring or ZDR agreement in place, those protections apply to requests routed through Anarlog as well. Your notes are stored on your device regardless of which provider processes them.
