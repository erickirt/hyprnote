...
![Anarlog and Meetily compared: both local-first, differing in polish and focus](/images/blog/articles/char-vs-meetily/anarlog-vs-meetily-axes.png)
...
Meetily runs on macOS and Windows, with Linux available through a source build. Anarlog has stable macOS builds plus Windows and Linux beta builds. If platform maturity is the deciding factor, compare the current installers on your own hardware.
...
*Anarlog keeps recording controls and meeting templates in the same desktop view where you prepare notes before a call.*
...
*Anarlog keeps the structured summary beside the local meeting history, so the record remains connected to the rest of your work.*
...
[Download Anarlog](https://anarlog.so/download) and run your first meeting with local processing. Upgrade to Pro at $15/month if you want cloud transcription and speaker identification without managing API keys.
