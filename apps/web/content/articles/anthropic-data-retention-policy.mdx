...
![How Anthropic's consumer Claude apps and the Anthropic API handle conversation data differently](/images/blog/articles/anthropic-data-retention-policy/claude-data-paths.png)
