...
![How Mistral handles prompts: default limited retention, an optional zero-retention path, and training only with explicit opt-in](/images/blog/articles/mistral-data-retention-policy/mistral-data-flow.png)
