...
The storage column matters after the call ends. If you are trying to locate Zoom's own records first, see [how to find your Zoom meeting history](/blog/see-zoom-meeting-history).

![Four ways to capture a Zoom meeting](/images/blog/articles/best-ai-notetaker-for-zoom/zoom-capture-paths.png)
...
![Zoom My Notes open during a call with live notes and transcript controls](/images/blog/library/products/zoom/my-notes/2026-08-30-during-meeting.webp)

*Zoom's current My Notes product view shows the personal note panel working during a meeting. Source: [Zoom](https://www.zoom.com/en/products/ai-assistant/features/ai-note-taking/).*
