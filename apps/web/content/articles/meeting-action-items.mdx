...
![The five parts of a useful meeting action item: action, owner, deadline, source, and definition of done](/images/blog/articles/meeting-action-items/action-item-anatomy.png)
...
![A meeting action item moving from source evidence into one system of execution and a review checkpoint](/images/blog/articles/meeting-action-items/meeting-action-handoff-v4.png)
