...
![tl;dv alternatives grouped by use case](/images/blog/articles/tldv-alternatives/tldv-alternatives-map.png)
...
![Current Anarlog new-note screen with the Record button and suggested templates](/images/blog/library/products/anarlog/desktop/2026-08-27-new-note.png)

*Anarlog starts recording and note preparation in the same local desktop view.*
...
![Tactiq Live Transcript panel beside a Microsoft Teams browser meeting](/images/blog/library/products/tactiq/microsoft-teams/tactiq-2026-07-17-live-transcript.png)

*Tactiq's official Teams guide shows its Live Transcript panel beside a browser meeting. Source: [Tactiq](https://help.tactiq.io/en/articles/9560779-how-to-use-tactiq-with-microsoft-teams).*
...
![MeetGeek meeting view with speaker talk time, video, transcript, and AI insights](/images/blog/library/products/meetgeek/meeting-insights/2026-08-30-insights.webp)

*MeetGeek's current meeting-insights page shows speaker analytics, transcript context, and AI-generated coaching cards. Source: [MeetGeek](https://meetgeek.ai/features/meeting-insights).*
...
![Supernormal meeting record with post-meeting actions for slides, email, and action items](/images/blog/library/products/supernormal/meeting-notes/2026-08-30-post-meeting-actions.webp)

*Supernormal's current meeting-notetaker page shows its desktop capture opening a meeting record with post-meeting actions. Source: [Supernormal](https://www.supernormal.com/meeting-notetaker).*
...
- Video capture in Zoom or Teams can still require a visible bot
