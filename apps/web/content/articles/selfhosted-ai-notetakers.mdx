...
| **Anarlog**     | MIT         | macOS; Windows and Linux beta | Parakeet V3, Parakeet Batch + 7 cloud | Ollama / LM Studio | Free (local) · $15/mo cloud |
...
![Anarlog meeting summary with recent meetings in the local sidebar](/images/blog/library/products/anarlog/desktop/2026-08-20-meeting-summary.jpg "char-editor-width=80")
...
![Scriberr desktop and mobile recording libraries](/images/blog/articles/selfhosted-ai-notetakers/telegram-cloud-photo-size-5-6282995305728905641-w.jpg "char-editor-width=80")
...
![Vibe desktop app with language, model, and audio-file controls](/images/blog/articles/selfhosted-ai-notetakers/telegram-cloud-photo-size-5-6282995305728905642-y.jpg "char-editor-width=80")
...
![Whishper upload dialog with file, URL, model, and language controls](/images/blog/library/products/whishper/transcription/2026-08-30-upload-dialog.png "char-editor-width=80")

*Whishper's official documentation demo shows the browser upload dialog and transcription controls. Source: [Whishper Docs](https://whishper-docs.pages.dev/usage/transcriptions/).*
...
![WhisperX GitHub repository with installation files and project documentation](/images/blog/articles/selfhosted-ai-notetakers/screenshot-2026-04-20-at-12-53-00-pm-1.png "char-editor-width=80")

*WhisperX is a CLI and Python library rather than a standalone graphical app, so its official repository is the relevant product surface. Source: [WhisperX on GitHub](https://github.com/m-bain/whisperX).*
